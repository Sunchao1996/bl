...
import com.bl.sys.dao.SysRoleDao;
import com.bl.sys.dao.SysUserDao;
import com.bl.sys.model.SysDic;
import com.bl.sys.model.SysUser;
import com.bl.sys.vo.SysUserSearchVO;
import com.bl.book.util.code.RandomCodeUtil;
import com.bl.book.util.date.DateUtil;
import com.bl.book.util.encrypt.Md5SaltUtil;
import com.bl.book.util.excel.Excel2007Util;
import com.bl.book.util.file.FileUtil;
...
public class SysUserService {
	...
	public List<String> importUser(HttpServletRequest request, MultipartFile file, List<String> valicationList) {
		...
		List<Object> department = new ArrayList<>();// 部门
