        ...
        <form role="form" id="resouceForm" name="resouceForm" class="form-horizontal"
            ...
            <div class="form-body">
                <div class="form-group">
                 ...
                 <input id="type" name="type" type="hidden" class="form-control input-inline  input-xlarge"                            
                               value="2" readonly /> 
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input id="url" type="text" name="url" class="form-control input-inline  input-xlarge"
                               placeholder="请输入非中文字符，长度最大200个字符" value="" maxlength="200"><label id="urlTip"></label>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group input-xlarge">
                            <input id="iconImg" type="hidden" name="iconImg" class="form-control" placeholder="" value="">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">描述：</label>
                     <div class="col-md-9">
                      <textarea id="description" name="description" class="form-control input-inline  input-xlarge " rows="3 " maxlength= "50" placeholder="只能输入50个字符"></textarea>
                    </div>
