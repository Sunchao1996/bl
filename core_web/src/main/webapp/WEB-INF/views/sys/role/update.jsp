                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input id="name" name="name" type="text" class="form-control input-inline  input-xlarge"
                               placeholder=""
                               value="${sysRole.name}" maxlength="20"> <label id="nameTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input id="displayOrder" name="displayOrder" type="text"
                               ...
                               placeholder=""
                               value="${sysRole.displayOrder}" maxlength="6"> <label id="displayOrderTip"></label>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">角色描述：</label>
                    <div class="col-md-10">
                        <textarea rows="5" cols="60" id="description" name="description"  class="form-control input-inline  input-xlarge" maxlength="50">${sysRole.description}</textarea>
                 ...
                 <div class="col-md-10">
			       <div class="">
			         <table id="treeTable" class="table table-striped table-bordered table-hover">	
			           <thead>
			             <tr>
			               <th width="50%"><label class="mt-checkbox mt-checkbox-outline"><input name="checkAllChange" type="checkbox" id="checkAllChange"/><span></span> 模块</label></th>
			               <th width="50%">功能</th>
			             </tr>
			           </thead>	          
			          <tbody>
