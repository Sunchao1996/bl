...
<head>
    ...
    <link rel="stylesheet"
          href="${staticServer}/assets/metronic4.7/global/plugins/font-awesome/css/font-awesome.min.css?versionNo=${versionNo}"
          type="text/css"/>
    <link rel="stylesheet"
          href="${staticServer}/assets/metronic4.7/global/plugins/simple-line-icons/simple-line-icons.min.css"
          type="text/css"/>
    <link rel="stylesheet" href="${staticServer}/assets/metronic4.7/global/plugins/bootstrap/css/bootstrap.min.css"
          type="text/css"/>
    <link rel="stylesheet"
          href="${staticServer}/assets/metronic4.7/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css"
          type="text/css"/>
    <link rel="stylesheet"
          href="${staticServer}/assets/metronic4.7/global/plugins/select2/css/select2.min.css?versionNo=${versionNo}"
          type="text/css"/>
    <link rel="stylesheet"
          href="${staticServer}/assets/metronic4.7/global/plugins/select2/css/select2-bootstrap.min.css?versionNo=${versionNo}"
          type="text/css"/>
    <link rel="stylesheet"
          href="${staticServer}/assets/metronic4.7/global/css/components.min.css?versionNo=${versionNo}"
          type="text/css"/>
                        ...
                        <div class="col-md-6 col-xs-12 col-md-offset-2">
                            <div class="col-xs-12">
                                <input class="form-control form-control-solid placeholder-no-fix form-group" type="text"
                                       autocomplete="off" placeholder="账号" name="username" id="username" required/>
                            </div>
                            <div class="col-xs-12">
...
<script src="${staticServer}/assets/metronic4.7/global/plugins/bootstrap/js/bootstrap.min.js"
        type="text/javascript"></script>
<script src="${staticServer}/assets/metronic4.7/global/plugins/js.cookie.min.js" type="text/javascript"></script>
<script src="${staticServer}/assets/metronic4.7/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js"
        type="text/javascript"></script>
<script src="${staticServer}/assets/metronic4.7/global/plugins/jquery.blockui.min.js" type="text/javascript"></script>
<script src="${staticServer}/assets/metronic4.7/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js"
        type="text/javascript"></script>
<script src="${staticServer}/assets/metronic4.7/global/plugins/jquery-validation/js/jquery.validate.min.js"
        type="text/javascript"></script>
<script src="${staticServer}/assets/metronic4.7/global/plugins/jquery-validation/js/additional-methods.min.js"
        type="text/javascript"></script>
<script src="${staticServer}/assets/metronic4.7/global/plugins/select2/js/select2.full.min.js"
        type="text/javascript"></script>
<script src="${staticServer}/assets/metronic4.7/global/plugins/backstretch/jquery.backstretch.min.js"
        type="text/javascript"></script>
